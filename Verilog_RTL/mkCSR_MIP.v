...
module mkCSR_MIP(CLK,
  ...
  wire [11 : 0] new_mip__h506, new_mip__h912;
  wire seip__h540, ssip__h544, stip__h542, ueip__h541, usip__h545, utip__h543;
  ...
  // value method mv_read
  assign mv_read = { 52'd0, new_mip__h506 } ;

  // actionvalue method mav_write
  assign mav_write = { 52'd0, new_mip__h912 } ;
  ...
  // register rg_ssip
  assign rg_ssip$D_IN = !EN_reset && ssip__h544 ;
  assign rg_ssip$EN = EN_mav_write || EN_reset ;

  // register rg_stip
  assign rg_stip$D_IN = !EN_reset && stip__h542 ;
  assign rg_stip$EN = EN_mav_write || EN_reset ;

  // register rg_ueip
  assign rg_ueip$D_IN = !EN_reset && ueip__h541 ;
  assign rg_ueip$EN = EN_mav_write || EN_reset ;

  // register rg_usip
  assign rg_usip$D_IN = !EN_reset && usip__h545 ;
  assign rg_usip$EN = EN_mav_write || EN_reset ;

  // register rg_utip
  assign rg_utip$D_IN = !EN_reset && utip__h543 ;
  assign rg_utip$EN = EN_mav_write || EN_reset ;

  // remaining internal signals
  assign new_mip__h506 =
	     { rg_meip,
	       1'b0,
	       rg_seip,
	       rg_ueip,
  ...
  assign new_mip__h912 =
	     { rg_meip,
	       ...
	       ssip__h544,
	       usip__h545 } ;
  assign seip__h540 = mav_write_misa[18] && mav_write_wordxl[9] ;
  assign ssip__h544 = mav_write_misa[18] && mav_write_wordxl[1] ;
  assign stip__h542 = mav_write_misa[18] && mav_write_wordxl[5] ;
  assign ueip__h541 = mav_write_misa[13] && mav_write_wordxl[8] ;
  assign usip__h545 = mav_write_misa[13] && mav_write_wordxl[0] ;
  assign utip__h543 = mav_write_misa[13] && mav_write_wordxl[4] ;
